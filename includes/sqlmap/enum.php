            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div id="display_enum_db_data_form" align="central">
                  <label for="enum_db">DB(s) à dumper ou à énumérer:</label>
                ...
                <div id="display_enum_table_data_form" align="central">
                  <br />
                  <label for="enum_table">Table(s) à dumper ou à énumérer:</label>
                ...
                <div id="display_enum_column_data_form" align="central">
                  <br />
                  <label for="enum_column">Column(s) à dumper ou à énumérer:</label>
                ...
                <div id="display_enum_not_column_data_form" align="central">
                  <br />
                  <label for="enum_exclude_column">Column(s) exclure ou ne pas énumérer:</label>
                ...
                <div id="display_enum_db_user_data_form" align="central">
                  <br />
                  <label for="enum_db_user">Utilisateur de base de données spécifique à énumérer:</label>
                ...
                <div id="display_enum_where_data_form" align="central">
                  <br />
                  <label for="enum_where">Où condition pour filtrer les résultats de dump:</label>
              ...
              <div class="col-md-1"></div>
              <div class="col-md-4">
                <label for="select_enum_options">Sélectionnez les options d'énumération à activer:</label>
                <select class="form-control" id="enum_options" name="enum_options[]" size="19" onchange="enumCheck()" multiple>
                  <option value="getAll">Énumérer Tout!</option>
                  <option value="getBanner" selected="selected">Informations sur la version ou la bannière</option>
